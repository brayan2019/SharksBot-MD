...
const isCommand7 = /^(openaivoz|chatgptvoz|iavoz|robotvoz|openai2voz|chatgpt2voz|ia2voz|robot2voz|gatavoz|SharkBotvoz|gptvoz|ai_voz|ai_voce)$/i.test(command)
...
try {
let syms = `Actuaras como un Bot de WhatsApp el cual fue creado por brayan2019, tu seras SharksBot-MD`
...
case isCommand5:
if (!text) return m.reply(lenguajeGB.smsMalused2() + `*${usedPrefix + command}* SharkBot`)
try{
...
handler.command = /^(googlef?|openai|chatgpt|ia|ai|bot|simi|simsimi|alexa|bixby|cortana|siri|okgoogle|githubstalk|usuariogithub|usergithub|(yt(s|search)|(openaivoz|chatgptvoz|iavoz|robotvoz|openai2voz|chatgpt2voz|ia2voz|robot2voz|gatavoz|SharkBotvoz|gptvoz|ai_voz|ai_voce)|(translate|traducir|trad)))$/i
