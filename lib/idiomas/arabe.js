...
const smsContacto4 = () => { return 'جهة اتصال SharkBot الرسمية 🦈'}
...
const smsJBConexionClose = () => { return `${lenguajeGB['smsAvisoFG']()}🔴 *تم إغلاق الاتصال ، يجب عليك الاتصال يدويًا باستخدام الأمر #sharkbot وإعادة إنشاء رمز الاستجابة السريعة الجديد${lenguajeGB['smsJBConexionTrue3']()}* *الذي تم إرساله لأول مرة تم إنشاء بوت فرعي*`}
