...
const smsContacto4 = () => { return 'Kontak Resmi SharkBot 🦈'}
...
const smsJBConexionClose = () => { return `${lenguajeGB['smsAvisoFG']()}🔴 *KONEKSI TELAH DITUTUP, ANDA HARUS CONNECT MANUAL MENGGUNAKAN PERINTAH #sharkbot DAN RESCAN QR CODE BARU${lenguajeGB['smsJBConexionTrue3']()}* *YANG DIKIRIM PERTAMA KALI SUB BOT DIBUAT*`}
...
//_allantilink.js 
const smsTextoYT = () => { return '🦈 SharkBot-MD - 𝗪𝗵𝗮𝘁𝘀𝗔𝗽𝗽 '} 
...
const smsMenuTotal2 = () => { return "sharkbot"}
